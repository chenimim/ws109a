const Pos = {
  ...
  Pos.calcPrice = function () {
    ...
    if(a=="香菇大戰毒蛇:200"){document.getElementById("image").src = "im/7.jpg";}
    if(a=="益智小遊戲:250"){document.getElementById("image").src = "im/8.jpg";}
    if(a=="異世界大亂鬥:350"){document.getElementById("image").src = "im/9.png";}
